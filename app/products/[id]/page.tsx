...
const ProductDetails = async ({params:{id}}:Props) => {
    ...
    <div className='product-container'>
        <div className='flex gap-28 xl:flex-row flex-col'>
            ...
            <Image src={product.image} alt={product.title} width={580} height={400}></Image>
            </div>
            <div className='flex-1 flex flex-col'>
                <div className='flex justify-between items-start gap-5 flex-wrap pb-6'>
                    ...
                    <div className='flex item-center gap-3'>
                        ...
                        <div className='p-2 bg-white-200 rounnded-10'>
                            <Image
                ...
                <div className='product-info' >
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='flex gap-3'>
                            ...
                            height={16}
                            />
                            <p className='text-sm text-primary-orange font-semibold'>{product.stars || '200'}</p>
                        </div>
                    ...
                    <p className='text-sm text-black opacity-50'>
                        <span className='text-primary-green font-semibold'>89% </span>Buyers recommended
                    </p>
                </div>
            </div>
